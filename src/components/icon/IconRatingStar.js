...
const IconRatingStar = ({currentColor = "#aebfcf"}) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="10.033" height="9.613" viewBox="0 0 10.033 9.613">
      <path id="star"
            ...
            transform="translate(0.001 -1.047)" fill={currentColor}/>
    </svg>
  )
};
